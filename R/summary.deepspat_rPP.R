#' @title Summarize a fitted r-Pareto process model
#' @description Computes warped coordinates, fitted dependence parameters, and optional uncertainty estimates for a fitted \code{deepspat_rPP} object.
